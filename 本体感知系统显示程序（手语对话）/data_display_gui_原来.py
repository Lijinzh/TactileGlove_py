...
class DataDisplay(QMainWindow):
    ...
    def button4_callback(self):
        ...
        self.save_calibration_data_with_label(self.resistances_list, "resistances_list",'27')
    ...
    def button5_callback(self):
        ...
        self.save_calibration_data_with_label(self.my_stretch_ratios, "my_stretch_ratios",'26')
